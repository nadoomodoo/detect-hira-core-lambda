// @ts-nocheck
import type { Theme as GridTheme } from "../../common/styles";
...
import type { BaseGridMouseEventArgs } from "./event-args";
...
/** @category Types */
export type AttachmentEditorType = React.ComponentType<OverlayImageEditorProps>;
...
export interface BaseGridColumn {
  ...
  readonly themeOverride?: Partial<GridTheme>;
...
export type InnerColumnExtension = {
  ...
  headerRowMarkerTheme?: Partial<GridTheme>;
...
/** @category Cells */
export type ReadWriteGridCell = TextCell | NumberCell | MarkdownCell | UriCell | BooleanCell | CustomCell | ImageCell | AttachmentCell;

/** @category Cells */
export type EditableGridCell = ReadWriteGridCell;
...
export function isTextEditableGridCell(cell: GridCell): cell is ReadWriteGridCell {
  if (
    ...
    cell.kind === GridCellKind.Attachment ||
...
/** @category Cells */
export interface AttachmentCell extends BaseGridCell {
  readonly kind: GridCellKind.Attachment;
  readonly data: string[];
  readonly displayData?: string[]; // used for small images for faster scrolling
  readonly readonly?: boolean;
}
...
export type ProvideEditorComponent<T extends InnerGridCell> = React.FunctionComponent<{
  ...
  readonly attachmentEditorOverride?: AttachmentEditorType;

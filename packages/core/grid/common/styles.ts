...
export function makeCSSStyle(theme: Theme): Record<string, string> {
  return {
    ...
    '--gdg-bg-header-selected': theme.bgHeaderSelected,
    ...
    '--gdg-horizontal-border-color':
      theme.horizontalBorderColor ?? theme.borderColor,
...
const dataEditorBaseTheme: Theme = {
  ...
  bgCellMedium: '#FAFAFB',
  bgHeader: '#F0F0F3',
  bgHeaderSelected: '#5283ff',
  bgHeaderHasFocus: '#E9E9EB',
  bgHeaderHovered: '#E8E8EC',
  ...
  markerFontStyle: '9px',
  fontFamily:
    '"Pretendard Variable", Inter, Roboto, -apple-system, BlinkMacSystemFont, avenir next, avenir, segoe ui, helvetica neue, helvetica, Ubuntu, noto, arial, sans-serif',
  editorFontSize: '13px',
...
export function mergeAndRealizeTheme(
  theme: Theme,

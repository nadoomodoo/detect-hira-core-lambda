      ...
      <div className="container">
        <div className="footer-top">
          ...
          <div className="footer-brand">
            ...
            <p className="footer-tagline">분야별 AI API 마켓플레이스</p>
            <address className="footer-company">
              주식회사 나두모두
              <br />
              서울특별시 강남구 테헤란로 501, 5층 501호 (삼성동, 브이플렉스)
              <br />
              사업자번호 361-86-02611 · 대표 문영호
              <br />
              통신판매업신고 2023-서울강남-02876
              <br />
        ...
        <div className="footer-iso">
          <img
            src="/iso_mark.webp"
            alt="ISO/IEC 27001 인증"
            className="footer-iso-mark"
          />
          <span className="muted">
            정보보호 국제표준{" "}
            <b style={{ color: "#cbd5e1", fontWeight: 700 }}>ISO/IEC 27001</b>{" "}
            인증 — 고객 데이터를 안전하게 보호합니다.
          </span>
        </div>
        ...
        <div className="footer-bottom">
          <span className="muted">
            © 2026 나두AI · 주식회사 나두모두. All rights reserved.
          </span>

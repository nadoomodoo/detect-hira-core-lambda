...
export const uriCellRenderer: InternalCellRenderer<UriCell> = {
  ...
  draw: (a) => {
    ...
    if (
      ...
      if (
        ...
        ctx.moveTo(
          rect.x + x,
          Math.floor(rect.y + drawY + h + underlineOffset) + 0.5,
        );
        ctx.lineTo(
          rect.x + x + w,
          Math.floor(rect.y + drawY + h + underlineOffset) + 0.5,
        ...
        drawTextCell(
          { ...a, rect: { ...rect, x: rect.x - 1 } },
          txt,
          cell.contentAlign,
        );
        drawTextCell(
          { ...a, rect: { ...rect, x: rect.x - 2 } },
          txt,
          cell.contentAlign,
        );
        drawTextCell(
  ...
  measure: (ctx, cell, theme) =>
    ctx.measureText(cell.displayData ?? cell.data).width +
    ...
    return (
      <UriOverlayEditor
        forceEditMode={
          value.readonly !== true &&
          (forceEditMode ||
            (cell.hoverEffect === true && cell.onClickUri !== undefined))
        }
        uri={value.data}

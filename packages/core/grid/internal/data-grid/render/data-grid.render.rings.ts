...
import { type GridSelection, type InnerGridCell, type Item } from "../data-grid-types";
...
import { hugRectToTarget, intersectRect, rectContains, splitRectIntoRegions } from "../../../common/math";
